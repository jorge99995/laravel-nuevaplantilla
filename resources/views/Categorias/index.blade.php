                    ...
                    <div class="table-responsive">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                <th class="min-w-250px">Categoria</th>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="ms-5">
                                        ...
                                        <a href="edit-category.html"
                                            ...
                                            data-kt-ecommerce-category-filter="category_name">{{ $items->nombre_categoria }}</a>

                                        <div class="text-muted fs-7 fw-bold">{{ $items->descripcion_categoria }}</div>
